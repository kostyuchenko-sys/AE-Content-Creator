...
4. Укажи `templateId`, `name`, `description`, `output folder`.
5. Нажми **Build package** — будет собран пакет.

## Важно

Скрипт не делает “Reduce Project” автоматически (это может быть разрушительно).  
Если нужно, запускай упаковку на копии проекта.
